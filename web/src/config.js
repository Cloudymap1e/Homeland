...
const map05Waves = createWavePlan({
  totalWaves: 23,
  spawnStart: 0.828,
  spawnFloor: 0.298,
  routeWeights: [0.2, 0.18, 0.16, 0.14, 0.17, 0.15],
  baseCounts: { scout: 7, raider: 6, barge: 2, juggernaut: 1 },
  growth: { scout: 0.54, raider: 0.47, barge: 0.28, juggernaut: 0.123 },
  surgeEvery: 2,
  surgeBoost: 3,
});

const PASS_RUN_TARGETS_BY_MAP_INDEX = [30, 50, 60, 90, 100, 120];
const MC_PASS_RATE_TARGETS_BY_MAP_INDEX = [0.9, 0.85, 0.8, 0.77, 0.58, 0.5];
...
export const MAPS = {
  ...
  map_05_blackwater_lattice: {
    mapId: 'map_05_blackwater_lattice',
    name: 'Map 5 - Blackwater Lattice',
    seed: 547,
    startingCoins: 25500,
    startingXp: 0,
    ...
    buildSlots: [
      ...
      { id: 's04', x: 0.11, y: 0.28 },
      { id: 's05', x: 0.14, y: 0.58 },
      { id: 's06', x: 0.16, y: 0.88 },
      { id: 's07', x: 0.22, y: 0.25 },
      { id: 's08', x: 0.24, y: 0.55 },
      { id: 's09', x: 0.27, y: 0.86 },
      { id: 's10', x: 0.33, y: 0.22 },
      { id: 's11', x: 0.35, y: 0.52 },
      { id: 's12', x: 0.38, y: 0.84 },
      { id: 's13', x: 0.45, y: 0.19 },
      { id: 's14', x: 0.47, y: 0.49 },
      { id: 's15', x: 0.5, y: 0.79 },
      { id: 's16', x: 0.57, y: 0.17 },
      { id: 's17', x: 0.6, y: 0.44 },
      { id: 's18', x: 0.63, y: 0.73 },
      { id: 's19', x: 0.7, y: 0.15 },
      { id: 's20', x: 0.72, y: 0.39 },
      { id: 's21', x: 0.75, y: 0.66 },
      { id: 's22', x: 0.81, y: 0.15 },
      { id: 's23', x: 0.83, y: 0.34 },
      { id: 's24', x: 0.85, y: 0.58 },
      { id: 's25', x: 0.9, y: 0.16 },
